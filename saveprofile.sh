...
if [ -z "$1" ]; then
   exit
	...
	sudo sed -i '/^\[/h;G;/LastProfile/s/\(LPNum=\).*/\1'"$2"'/m;P;d'  $dirn
	#
	...
	sudo sed -i '/^\[/h;G;/Profile 0/s/\(RXOffset=\).*/\1'"$3"'/m;P;d'  $dirn
	sudo sed -i '/^\[/h;G;/Profile 0/s/\(TXOffset=\).*/\1'"$4"'/m;P;d'  $dirn
	sudo sed -i '/^\[/h;G;/Profile 0/s/\(RXFrequency=\).*/\1'"$5"'/m;P;d'  $dirn
	sudo sed -i '/^\[/h;G;/Profile 0/s/\(TXFrequency=\).*/\1'"$6"'/m;P;d'  $dirn
	sudo sed -i '/^\[/h;G;/Profile 0/s/\(Callsign=\).*/\1'"$7"'/m;P;d'  $dirn
	sudo sed -i '/^\[/h;G;/Profile 0/s/\(Id=\).*/\1'"$8"'/m;P;d'  $dirn
    fi	
	...
	sudo sed -i '/^\[/h;G;/Profile '"$2"'/s/\(Password=\).*/\1'"PWFILE"'/m;P;d'  $dirn

	sudo sed -i '/^\[/h;G;/Profile '"$2"'/s/\(Name=\).*/\1'"$7 $8"'/m;P;d'  $dirn
	sudo sed -i '/^\[/h;G;/Profile '"$2"'/s/\(TalkGroup=\).*/\1'"$8"'/m;P;d'  $dirn

	sudo sed -i '/^\[/h;G;/Profile 0/s/\(Address=\).*/\1'"$3"'/m;P;d'  $dirn
	sudo sed -i '/^\[/h;G;/Profile 0/s/\(Mode=\).*/\1'"$4"'/m;P;d'  $dirn
	sudo sed -i '/^\[/h;G;/Profile 0/s/\(Port=\).*/\1'"$5"'/m;P;d'  $dirn
	sudo sed -i '/^\[/h;G;/Profile 0/s/\(Password=\).*/\1'"PWFILE"'/m;P;d'  $dirn

	sudo sed -i '/^\[/h;G;/Profile 0/s/\(Name=\).*/\1'"$7 $8"'/m;P;d'  $dirn
	sudo sed -i '/^\[/h;G;/Profile 0/s/\(TalkGroup=\).*/\1'"$8"'/m;P;d'  $dirn
